    ...
    return(
        <div className={`accordion-container ${className}`}>
            <div className="accordion-header">
                ...
                <IoIosArrowDown size="2rem" onClick={handleOpenContent} style={{transform: bodyHeight === "100%" ? 'rotate(0deg)' : 'rotate(180deg)', transition: 'all 0.2s ease-in 0s', cursor: 'pointer'}}/>
            </div>
